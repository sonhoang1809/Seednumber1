...
public class CreateUserByAdminController extends HttpServlet {
    ...
    private final String ERROR = "create-user.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (UserDAO.checkValidUserID(userID)) {
                ...
                request.setAttribute("ERRORUSERIDMESSAGE", "THIS USERID: " + userID + " IS ALDREADY USED");
            }
        } catch (SQLException ex) {
            log("Error at CreateUserByAdminController: " + ex.toString());
        } finally {
